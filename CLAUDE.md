...
Offene Punkte aus der SPEC-Prüfung: [`docs/offene_fragen.md`](docs/offene_fragen.md).
...
- Solange Punkt 1 in `docs/offene_fragen.md` nicht entschieden ist, wird **kein Code gebaut,
  der löscht** — das betrifft die Phasen 5 und 6 der SPEC.
